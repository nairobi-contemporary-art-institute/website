...
const socialLinks = [
    ...
    {
        name: 'YouTube',
        href: 'https://www.youtube.com/channel/UCksImP-7-ulit6xSE399D7g',
        icon: (
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    {
        name: 'X',
        href: 'https://twitter.com/ncai254?lang=en',
        icon: (
            <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
