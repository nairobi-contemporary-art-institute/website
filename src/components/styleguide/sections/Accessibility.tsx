...
export function Accessibility() {
    return (
        <div className="space-y-16">
            <header>
                <h2 className="text-xs font-bold text-umber/40 uppercase tracking-[0.4em] mb-4">Section 10</h2>
            ...
            <section className="grid md:grid-cols-2 gap-12">
                <div className="space-y-8">
                    <h3 className="text-xs font-bold text-charcoal uppercase tracking-widest border-b border-umber/10 pb-2 inline-block">Visual Standards</h3>
                ...
                <div className="space-y-8">
                    <h3 className="text-xs font-bold text-charcoal uppercase tracking-widest border-b border-umber/10 pb-2 inline-block">Structural Standards</h3>
                    <ul className="space-y-4 text-sm text-umber/80 leading-relaxed list-none">
