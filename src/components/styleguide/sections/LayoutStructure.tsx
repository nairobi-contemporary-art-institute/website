...
export function LayoutStructure() {
    return (
        <div className="space-y-16">
            <header>
                <h2 className="text-xs font-bold text-umber/40 capitalize tracking-[0.4em] mb-4">Section 04</h2>
            ...
            <section className="space-y-8">
                <h3 className="text-xs font-bold text-charcoal capitalize tracking-widest border-b border-umber/10 pb-4">Global Container</h3>
                <div className="bg-umber/5 p-4 md:p-12 relative border border-dashed border-umber/20">
                    <div className="absolute top-0 left-0 text-[8px] bg-charcoal text-ivory px-2 py-1 capitalize tracking-widest font-bold">.container --max-w-5xl</div>
                    <div className="h-40 bg-ivory shadow-sm flex items-center justify-center">
                        <span className="text-[10px] font-bold text-umber/40 capitalize tracking-widest italic">Main Content Area</span>
                    </div>
            ...
            <section className="grid md:grid-cols-3 gap-8">
                <div className="space-y-4">
                    <h4 className="text-[10px] font-bold capitalize tracking-widest text-charcoal">Desktop Breakpoint</h4>
                ...
                <div className="space-y-4">
                    <h4 className="text-[10px] font-bold capitalize tracking-widest text-charcoal">Tablet Rhythm</h4>
                    <p className="text-sm text-umber/70 leading-relaxed">
                ...
                <div className="space-y-4">
                    <h4 className="text-[10px] font-bold capitalize tracking-widest text-charcoal">Mobile Focus</h4>
                    <p className="text-sm text-umber/70 leading-relaxed">
