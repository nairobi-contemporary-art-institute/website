...
export default function ContactPage() {
    ...
    return (
        <div className="container mx-auto px-section-clamp py-20">
            ...
            <section className="px-section-clamp max-w-xl text-umber/80 space-y-12">
                <p>We welcome inquiries regarding our exhibitions, research, and programming.</p>

                <div className="grid gap-6">
                    <div>
                        <h2 className="text-xs capitalize tracking-widest font-bold text-charcoal mb-1">Email</h2>
                        <a href="mailto:info@ncai254.com" className="hover:text-amber-800 transition-colors">info@ncai254.com</a>
                    </div>
                    <div>
                        <h2 className="text-xs capitalize tracking-widest font-bold text-charcoal mb-1">Phone</h2>
                        <p>+254 000 000 000</p>
                    </div>
                </div>
            </section>
